...
import type { DataCard, ChartData, TableData, MetricData, ComparisonData } from '../types/api';
...
export function highlightCode(el: HTMLElement): void { Prism.highlightAllUnder(el); }
export function extractUrls(text: string): string[] { return [...new Set(text.match(/https?:\/\/[^\s\)\]]+/g) || [])]; }
