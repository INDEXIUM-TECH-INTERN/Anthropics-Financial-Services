...
export function createMessageBubble(options) {
...
export function createMessageActions(content, _text, onRegenerate) {
...
// ═══ Sources Inline ═══
export function renderSourcesInline(md, target) {
    if (target.querySelector('.message-sources'))
        return;
...
export function createFollowupChips(container, onSelect, suggestions = FOLLOWUP_SUGGESTIONS) {
